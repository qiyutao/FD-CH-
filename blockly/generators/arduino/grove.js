...
Blockly.Arduino.grove_motor_shield = function() {
  ...
  var speed = 40;//Blockly.Arduino.valueToCode(this, 'SPEED', Blockly.Arduino.ORDER_ATOMIC) || '127';
...
"{\n"+
     ...
     "  digitalWrite(2,LOW);//turn DC Motor B move clockwise\n"+
     "  digitalWrite(4,HIGH);\n"+
     "  digitalWrite(7,HIGH);//turn DC Motor A move anticlockwise\n"+
     "  digitalWrite(8,LOW);\n"+
"}\n";
    code="forward();\n";
...
"{\n"+
     "  analogWrite(9,"+speed+");//input a simulation value to set the speed\n"+
     "  analogWrite(10,"+speed+");\n"+
     "  digitalWrite(2,LOW);//turn DC Motor B move anticlockwise\n"+
     "  digitalWrite(4,HIGH);\n"+
     "  digitalWrite(7,LOW);//turn DC Motor A move anticlockwise\n"+
     "  digitalWrite(8,HIGH);\n"+
"}\n\n";
    code="right();\n";
...
"{\n"+
     "  analogWrite(9,"+speed+");//input a simulation value to set the speed\n"+
     "  analogWrite(10,"+speed+");\n"+
     "  digitalWrite(2,HIGH);//turn DC Motor B move clockwise\n"+
     "  digitalWrite(4,LOW);\n"+
     "  digitalWrite(7,HIGH);//turn DC Motor A move clockwise\n"+
     "  digitalWrite(8,LOW);\n"+
"}\n\n";
    code="left();\n";
...
"{\n"+
     "  analogWrite(9,"+speed+");//input a simulation value to set the speed\n"+
     "  analogWrite(10,"+speed+");\n"+
     "  digitalWrite(2,HIGH);//turn DC Motor B move anticlockwise\n"+
     "  digitalWrite(4,LOW);\n"+
     "  digitalWrite(7,LOW);//turn DC Motor A move clockwise\n"+
     "  digitalWrite(8,HIGH);\n"+
"}\n\n";
    code="backward();\n";
...
Blockly.Arduino.m_custom = function() {
  ...
  var dropdown_direction = this.getFieldValue('DIRECTION');
  var speed1 = value_a;//Blockly.Arduino.valueToCode(this, 'SPEED', Blockly.Arduino.ORDER_ATOMIC) || '127';
  var speed2 = value_b;
  Blockly.Arduino.setups_["setup_motor"] = "pinMode(8,OUTPUT);//I1\n"+
  "  pinMode(2,OUTPUT);//I2\n"+
  "  pinMode(9,OUTPUT);//speedPinA\n"+
  ...
  var code = "";
    Blockly.Arduino.definitions_['define_forward'] = "void forward()\n"+
"{\n"+
     "  analogWrite(9,"+speed1+");//input a simulation value to set the speed\n"+
